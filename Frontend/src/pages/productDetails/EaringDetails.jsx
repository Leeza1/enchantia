...
const EaringDetails = () => {
  ...
  // }
    ...
    const handleAddToCart = (earing) => {
      const cartItem = {
        id: earing.id,
        earname: earing.earname,
        earprice: earing.earprice,
        earimagea: earing.earimagea,
        earcategory: earing.earcategory,
      ...
      <div className='container-fluid main-body detail-page'>
        <section className='container-padding'>
          <div className='container mt-3'>
            <div className='row'>
              <div className='col-md-6 col-sm-12 earing-carousel'>
