...
const NecklaceDetails = () => {
  ...
  // }
    ...
    const handleAddToCart = (necklace) => {
      const cartItem = {
        id: necklace.id,
        necname: necklace.necname,
        necprice: necklace.necprice,
        necimagea: necklace.necimagea,
        neccategory: necklace.neccategory,
        ...
        <section className='container-padding'>
          <div className='container mt-3'>
            <div className='row'>
              ...
              <div className='col-md-6 col-sm-12 necklace-description'>
                <div>
                ...
                <div className='d-flex flex-row'>
                  ...
                  <div className="tp-necklace-details-rating">
                  ...
                  <div className="tp-necklace-details-reviews ms-2">
                ...
                <div className="tp-necklace-details-social mt-4">
