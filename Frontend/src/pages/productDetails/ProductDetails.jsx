        ...
        <section className="category-section no-bg container-padding">
          <div className=" container ">
            <div className="row">
              ...
              <div className="col-sm-12 col-md-6">
                <button type="button" className="btn btn-about mt-4 float-xs-start float-md-end" data-mdb-ripple-color="dark">Discover Now</button>
              </div>
            </div>
          </div>
          <div className="container mt-5">
            <div className="row">
              <div className="col-sm-6 col-md-3  category-img">
                <img src="https://asset.swarovski.com/images/$size_1450/t_swa002/c_scale,dpr_1.0,f_auto,w_700/5662493_ms1/gema-pendant--mixed-cuts--flower--pink--rhodium-plated-swarovski-5662493.jpg" alt="" className="img-fluid" />
              </div>
              <div className="col-sm-6 col-md-3  category-img"><img src="https://asset.swarovski.com/images/$size_1450/t_swa002/c_scale,dpr_1.0,f_auto,w_700/5656635_ms2/florere-stud-earrings--flower--pink--gold-tone-plated-swarovski-5656635.jpg" alt="" className="img-fluid" /></div>
              <div className="col-sm-6 col-md-3  category-img"><img src="https://asset.swarovski.com/images/$size_1450/t_swa002/c_scale,dpr_1.0,f_auto,w_700/5658396_ms3/gema-bracelet--mixed-cuts--flower--pink--rhodium-plated-swarovski-5658396.jpg" alt="" className="img-fluid" /></div>
              <div className="col-sm-6 col-md-3 category-img"><img src="https://asset.swarovski.com/images/$size_1450/t_swa002/c_scale,dpr_1.0,f_auto,w_700/5652138_ms2/dulcis-bracelet--candy--multicolored--gold-tone-plated-swarovski-5652138.jpg" alt="" className="img-fluid hover-zoom " /></div>
            </div>
          </div>
        </section>
      </div>
