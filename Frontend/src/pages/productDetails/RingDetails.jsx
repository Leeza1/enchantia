...
import { getSingleRingApi } from '../../apis/Api';
...
const RingDetails = () => {
  ...
  const handleRemoveQuantity = () => {
    ...
    return (
      ...
      //        <img className='object-cover rounded-3' height={'500px'} width={'600px'} src={ring.image} alt="" />
          ...
          <div className='container mt-3'>
            <div className='row'>
              ...
              <div className='col-md-6 col-sm-12 product-description'>
                ...
                <div>
                  <p className='para mt-4'>{ring.ringdetaildescription}</p>
                  <p className='best-seller-heading'>{ring.ringprice}</p>
                </div>
